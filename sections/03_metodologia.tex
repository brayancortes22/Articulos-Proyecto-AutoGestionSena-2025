...
Planificación de la Arquitectura: se estructuró el proyecto (la parte Web, Móvil y el backend) con buenas prácticas de desarrollo y se usó la IA para comparar opciones de estructuración y parte del desarrollo del código, asegurando una base sólida para el sistema del SENA.

2. Desarrollo y Programación con Apoyo Mutuo
...
Soporte con el Código: La IA nos fue de gran ayuda para resolver dudas de sintaxis. Esto nos permitió escribir un código más limpio y comprensible para todo el equipo, facilitando el mantenimiento y flujo del sistema.
